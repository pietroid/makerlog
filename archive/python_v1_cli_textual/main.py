...
from project.services.config_service import ensure_global_dir, read_config
from project.domain.project_discovery import find_nearest_makerbook
from project.presentation.file_manager import editor_loop, file_manager
