...
from journal.services.journal_service import append_journal, read_journal
from project.services.context_service import write_active_context
from project.services.commands_service import increment_usage
from conversation.services.ollama_service import call_ollama_checkin
from journal.domain.screenshot import cmd_screenshot
from common.styles import APP_CSS, CYAN
from header.presentation.header_bar import HeaderBar
from journal.presentation.scrollable_file import ScrollableFile
from journal.presentation.activity_log import ActivityLog
from conversation.presentation.claude_conversation import ClaudeConversationMixin
