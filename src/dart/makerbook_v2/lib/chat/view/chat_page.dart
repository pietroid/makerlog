...
import 'package:makerbook_v2/chat/cubit/chat_cubit.dart';
import 'package:makerbook_v2/chat/cubit/chat_state.dart';
import 'package:makerbook_v2/chat/repository/chat_repository.dart';
import 'package:makerbook_v2/chat/widgets/chat_conversation.dart';
import 'package:makerbook_v2/widgets/header.dart';
import 'package:makerbook_v2/widgets/input_bar.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        BlocBuilder<ChatCubit, ChatState>(
          builder: (context, state) {
            final prompts = context.read<ChatCubit>().repository.initialPrompts();
