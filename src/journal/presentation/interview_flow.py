...
Separation:
  - :mod:`src.journal.domain.interview` = pure data (schema + formatter)
...
from src.journal.domain.interview import QUESTIONS, format_entry
from src.common.styles import CYAN, STYLE, console
