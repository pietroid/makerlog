...
from src.project.services.config_service import read_config, register_project
from src.project.services.context_service import write_active_context, clear_active_context
from src.journal.services.journal_service import project_label, read_journal
from src.header.domain.time_tracker import read_elapsed_seconds, write_elapsed_seconds
from src.journal.presentation.interview_flow import run_interview, confirm_and_write
from src.project.presentation.logo import print_logo, show_file
from src.common.styles import STYLE, console
...
def editor_loop(journal_path: Path) -> None:
    ...
    from src.editor_app import EditorApp
