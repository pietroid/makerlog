...
:mod:`src.python.journal.domain.journal_parser` — no raw text parsing here.
"""
...
from src.python.journal.models.journal_entry import JournalEntry
from src.python.journal.services.journal_service import read_journal
from src.python.journal.domain.journal_parser import parse_journal_events
from src.python.common.styles import CYAN
